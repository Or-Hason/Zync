  ...
  return (
    <main className={styles.page}>
      <header className={styles.pageHeader}>
        <h1 className={styles.pageTitle}>{dm.title}</h1>
        <p className={styles.pageSubtitle}>{dm.subtitle}</p>
      </header>
      ...
      <section className={styles.letterSection} aria-labelledby="letter-template-heading">
        <div className={styles.letterSectionHeader}>
          <h2 className={styles.letterSectionTitle} id="letter-template-heading">
            {dm.letterTemplate.sectionTitle}
          </h2>
          <p className={styles.letterSectionSubtitle}>{dm.letterTemplate.sectionSubtitle}</p>
        </div>
