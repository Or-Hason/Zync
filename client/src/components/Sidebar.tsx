...
const NAV_ITEMS: NavItem[] = [
  ...
  { to: "/explorer",   label: en.nav.explorer,          ariaLabel: "Navigate to Job Explorer" },
  { to: "/jobs/add",   label: en.nav.addJob,            ariaLabel: "Navigate to Add Job" },
  { to: "/documents",  label: en.nav.documentsManager,  ariaLabel: "Navigate to Documents Manager" },
