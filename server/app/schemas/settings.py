...
# HH:MM pattern enforcing 15-minute steps (00, 15, 30, 45).
HH_MM_PATTERN = r"^(?:[01]\d|2[0-3]):(?:00|15|30|45)$"
...
class NotificationSettings(BaseModel):
    ...
    daily_notify_time: str | None = Field(
        default=None, pattern=HH_MM_PATTERN
    )
    ...
    immediate_job_threshold: int | None = Field(default=None, ge=1)
